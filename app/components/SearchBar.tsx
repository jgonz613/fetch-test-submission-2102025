...
const SearchBar = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        console.log("fetchData", page, numPage, sortBy, sortOrder, selectedBreeds);
        const data = await fetchDogs(numPage, page, sortBy, sortOrder, selectedBreeds);
  ...
  }, [page, sortBy, sortOrder, numPage, selectedBreeds, hasHydrated]);
